...
std::basic_istream<char, std::char_traits<char> >& myIstreamTestFunction(
...
std::basic_ios<char, std::char_traits<char> >& myIosTestFunction(
    std::basic_ios<char, std::char_traits<char> >& stream) {
...
int main() {
  ...
  std::cout << "not True: " << std::noboolalpha << "true"
            << "(the string), " << true << std::boolalpha << std::endl;
  std::cout << "boolalpha set: " << (bool)(std::cout.flags() & std::ios_base::boolalpha)
            << std::endl;
  ...
  std::cout << "fpos o_pos == n_pos ? " << (o_pos == n_pos ? "true" : "false") << std::endl;
  std::cout << "fpos !(o_pos == n_pos) ? " << (!(o_pos == n_pos) ? "true" : "false") << std::endl;
  std::cout << "fpos o_pos != n_pos ? " << (o_pos != n_pos ? "true" : "false") << std::endl;
