...
namespace std {
  ...
  template _UCXXEXPORT vector<char, allocator<char> >::vector(size_type n, const char& value,
                                                              const allocator<char>& al);
  ...
  template _UCXXEXPORT void vector<unsigned short int, allocator<unsigned short int> >::reserve(
      size_type n);
  ...
  template _UCXXEXPORT void vector<unsigned long int, allocator<unsigned long int> >::reserve(
      size_type n);
  ...
  template _UCXXEXPORT void vector<unsigned char, allocator<unsigned char> >::resize(
      size_type sz, const unsigned char& c);
  template _UCXXEXPORT void vector<short int, allocator<short int> >::resize(size_type sz,
                                                                             const short& c);
  template _UCXXEXPORT void vector<unsigned short int, allocator<unsigned short int> >::resize(
      size_type sz, const unsigned short int& c);
  template _UCXXEXPORT void vector<int, allocator<int> >::resize(size_type sz, const int& c);
  template _UCXXEXPORT void vector<unsigned int, allocator<unsigned int> >::resize(
      size_type sz, const unsigned int& c);
  template _UCXXEXPORT void vector<long int, allocator<long int> >::resize(size_type sz,
                                                                           const long int& c);
  template _UCXXEXPORT void vector<unsigned long int, allocator<unsigned long int> >::resize(
      size_type sz, const unsigned long int& c);
  template _UCXXEXPORT void vector<float, allocator<float> >::resize(size_type sz, const float& c);
  template _UCXXEXPORT void vector<double, allocator<double> >::resize(size_type sz,
                                                                       const double& c);
