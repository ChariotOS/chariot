...
namespace std {
  ...
  template _UCXXEXPORT string::size_type string::find_first_of(const char*, size_type pos,
                                                               size_type n) const;
  ...
  template _UCXXEXPORT string::size_type string::find_last_of(const char* s, size_type pos,
                                                              size_type n) const;
  ...
  template _UCXXEXPORT string::size_type string::find_first_not_of(const char*, size_type,
                                                                   size_type) const;
  ...
  //	template _UCXXEXPORT int string::compare(size_type pos1, size_type n1, const string & str)
  // const;
  template _UCXXEXPORT int string::compare(size_type pos1, size_type n1, const string& str,
