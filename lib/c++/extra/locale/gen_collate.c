...
static void add_superset_weight(char *t) {
  ...
  if (!comm_cur_ptr ||
      (strcmp(t, ((weighted_item_t *)(comm_cur_ptr->data))->symbol) != 0)) { /* now out of sync */
    if (superset_in_sync) { /* need a new section */
      ...
      memcpy(cur_rule, ((section_t *)(cur_base->section_list->data))->rules, MAX_COLLATION_WEIGHTS);
      memcpy(cur_section->rules, ((section_t *)(cur_base->section_list->data))->rules,
  ...
  if (cur_base == cur_col) {
    ...
    if (!cur_col->undefined_idx) {
      ...
      if (!strcmp(cur_base->name, "iso14651_t1")) {
        ...
        do_script();
        strcpy(linebuf,
               "order_start <UNDEFINED_SECTION>;forward;backward;forward;forward,position\n");
        pos_e = NULL;
        pos = linebuf;
        t = next_token();
        assert(t);
  ...
  }
  {
    ...
    if (cur_base) {
      fprintf(stderr, "  %6u der %6u reor %6u starter - %u new stubs",
              tnumnodes(cur_base->root_derived_wi), tnumnodes(cur_base->root_wi_index_reordered),
              tnumnodes(cur_base->root_starter_char), ll_count(cur_col->section_list, DT_REORDER));
    }
    fprintf(stderr, "\n");
...
static const char *base_name[] = {"iso14651_t1", "comm",  "cs_CZ", "ar_SA",
                                  "th_TH",       "ja_JP", "ko_KR"};
...
deps_t deps[] = {
    {"af_ZA", BASE_iso14651_t1}, {"am_ET", BASE_iso14651_t1}, {"ar_AE", BASE_iso14651_t1},
    {"ar_BH", BASE_iso14651_t1}, {"ar_DZ", BASE_iso14651_t1}, {"ar_EG", BASE_iso14651_t1},
    {"ar_IN", BASE_iso14651_t1}, {"ar_IQ", BASE_iso14651_t1}, {"ar_JO", BASE_iso14651_t1},
    {"ar_KW", BASE_iso14651_t1}, {"ar_LB", BASE_iso14651_t1}, {"ar_LY", BASE_iso14651_t1},
    {"ar_MA", BASE_iso14651_t1}, {"ar_OM", BASE_iso14651_t1}, {"ar_QA", BASE_iso14651_t1},
    {"ar_SA", BASE_ar_SA},       {"ar_SD", BASE_iso14651_t1}, {"ar_SY", BASE_iso14651_t1},
    {"ar_TN", BASE_iso14651_t1}, {"ar_YE", BASE_iso14651_t1}, {"az_AZ", BASE_iso14651_t1},
    {"be_BY", BASE_iso14651_t1}, {"bg_BG", BASE_iso14651_t1}, {"bn_BD", BASE_iso14651_t1},
    {"bn_IN", BASE_iso14651_t1}, {"br_FR", BASE_iso14651_t1}, {"bs_BA", BASE_iso14651_t1},
    {"ca_ES", BASE_comm},        {"cs_CZ", BASE_cs_CZ},       {"cy_GB", BASE_iso14651_t1},
    {"da_DK", BASE_comm},        {"de_AT", BASE_iso14651_t1}, {"de_BE", BASE_iso14651_t1},
    {"de_CH", BASE_iso14651_t1}, {"de_DE", BASE_iso14651_t1}, {"de_LU", BASE_iso14651_t1},
    {"el_GR", BASE_iso14651_t1}, {"en_AU", BASE_iso14651_t1}, {"en_BW", BASE_iso14651_t1},
    {"en_CA", BASE_comm},        {"en_DK", BASE_iso14651_t1}, {"en_GB", BASE_iso14651_t1},
    {"en_HK", BASE_iso14651_t1}, {"en_IE", BASE_iso14651_t1}, {"en_IN", BASE_iso14651_t1},
    {"en_NZ", BASE_iso14651_t1}, {"en_PH", BASE_iso14651_t1}, {"en_SG", BASE_iso14651_t1},
    {"en_US", BASE_iso14651_t1}, {"en_ZA", BASE_iso14651_t1}, {"en_ZW", BASE_iso14651_t1},
    {"eo_EO", BASE_iso14651_t1}, {"es_AR", BASE_comm},        {"es_BO", BASE_comm},
    {"es_CL", BASE_comm},        {"es_CO", BASE_comm},        {"es_CR", BASE_comm},
    {"es_DO", BASE_comm},        {"es_EC", BASE_comm},        {"es_ES", BASE_comm},
    {"es_GT", BASE_comm},        {"es_HN", BASE_comm},        {"es_MX", BASE_comm},
    {"es_NI", BASE_comm},        {"es_PA", BASE_comm},        {"es_PE", BASE_comm},
    {"es_PR", BASE_comm},        {"es_PY", BASE_comm},        {"es_SV", BASE_comm},
    {"es_US", BASE_comm},        {"es_UY", BASE_comm},        {"es_VE", BASE_comm},
    {"et_EE", BASE_comm},        {"eu_ES", BASE_iso14651_t1}, {"fa_IR", BASE_iso14651_t1},
    {"fi_FI", BASE_comm},        {"fo_FO", BASE_comm},        {"fr_BE", BASE_iso14651_t1},
    {"fr_CA", BASE_comm},        {"fr_CH", BASE_iso14651_t1}, {"fr_FR", BASE_iso14651_t1},
    {"fr_LU", BASE_iso14651_t1}, {"ga_IE", BASE_iso14651_t1}, {"gd_GB", BASE_iso14651_t1},
    {"gl_ES", BASE_comm},        {"gv_GB", BASE_iso14651_t1}, {"he_IL", BASE_iso14651_t1},
    {"hi_IN", BASE_iso14651_t1}, {"hr_HR", BASE_comm},        {"hu_HU", BASE_iso14651_t1},
    {"hy_AM", BASE_iso14651_t1}, {"id_ID", BASE_iso14651_t1}, {"is_IS", BASE_comm},
    {"it_CH", BASE_iso14651_t1}, {"it_IT", BASE_iso14651_t1}, {"iw_IL", BASE_iso14651_t1},
    {"ja_JP", BASE_ja_JP},       {"ka_GE", BASE_iso14651_t1}, {"kl_GL", BASE_comm},
    {"ko_KR", BASE_ko_KR},       {"kw_GB", BASE_iso14651_t1}, {"lt_LT", BASE_comm},
    {"lv_LV", BASE_comm},        {"mi_NZ", BASE_iso14651_t1}, {"mk_MK", BASE_iso14651_t1},
    {"mr_IN", BASE_iso14651_t1}, {"ms_MY", BASE_iso14651_t1}, {"mt_MT", BASE_iso14651_t1},
    {"nl_BE", BASE_iso14651_t1}, {"nl_NL", BASE_iso14651_t1}, {"nn_NO", BASE_iso14651_t1},
    {"no_NO", BASE_comm},        {"oc_FR", BASE_iso14651_t1}, {"pl_PL", BASE_comm},
    {"pt_BR", BASE_iso14651_t1}, {"pt_PT", BASE_iso14651_t1}, {"ro_RO", BASE_iso14651_t1},
    {"ru_RU", BASE_iso14651_t1}, {"ru_UA", BASE_iso14651_t1}, {"se_NO", BASE_iso14651_t1},
    {"sk_SK", BASE_cs_CZ},       {"sl_SI", BASE_comm},        {"sq_AL", BASE_iso14651_t1},
    {"sr_YU", BASE_iso14651_t1}, {"sv_FI", BASE_comm},        {"sv_SE", BASE_iso14651_t1},
    {"ta_IN", BASE_iso14651_t1}, {"te_IN", BASE_iso14651_t1}, {"tg_TJ", BASE_iso14651_t1},
    {"th_TH", BASE_th_TH},       {"ti_ER", BASE_iso14651_t1}, {"ti_ET", BASE_iso14651_t1},
    {"tl_PH", BASE_iso14651_t1}, {"tr_TR", BASE_comm},        {"tt_RU", BASE_iso14651_t1},
    {"uk_UA", BASE_iso14651_t1}, {"ur_PK", BASE_iso14651_t1}, {"uz_UZ", BASE_iso14651_t1},
    {"vi_VN", BASE_iso14651_t1}, {"wa_BE", BASE_iso14651_t1}, {"yi_US", BASE_iso14651_t1},
    {"zh_CN", BASE_iso14651_t1}, {"zh_HK", BASE_iso14651_t1}, {"zh_SG", BASE_iso14651_t1},
...
int main(int argc, char **argv) {
  ...
  while (--argc) {
    p = (const deps_t *)bsearch(*++argv, deps, sizeof(deps) / sizeof(deps[0]), sizeof(deps[0]),
                                dep_cmp);
    if (!p) {
      if (!strcmp("C", *argv)) {
...
static int old_main(int argc, char **argv) {
  ...
  fprintf(stderr,
          ...
          override_len, multistart_len, weightstr_len, wcs2colidt_len, index2weight_len,
          index2ruleidx_len, ruletable_len,
#warning mult by 2 for rule indecies
          (override_len + multistart_len + weightstr_len + wcs2colidt_len + index2weight_len +
           index2ruleidx_len + ruletable_len) *
              2,
          (override_len + multistart_len + weightstr_len + wcs2colidt_len + index2weight_len +
           index2ruleidx_len + ruletable_len + 511) /
              512);
...
static void do_colele(void) {
  ...
  if ((s = next_token()) != NULL) {
    e = strrchr(s, '>');
    if ((*s == '<') && e && (*e == '>') && !e[1]) {
      if (((s1 = next_token()) == NULL) || (strcmp(s1, "from") != 0) ||
          ((s1 = next_token()) == NULL) || (*s1 != '\"')) {
...
#warning devel code
  if (superset) {
    if (tfind(p, &cur_base->root_colitem, colitem_cmp)) {
      /* 			fprintf(stderr, "skipping superset duplicate collating item
       * \"%s\"\n", p->string); */
      del_colitem(p);
      return;
      /* 		} else { */
...
static void do_order_start(void) {
  ...
  if (*s == '<') { /* section (script) */
    ...
    if ((*cur_section->name != '<') &&
        (cur_section->num_items == 0)) { /* already in an empty anonymous section */
      sect = cur_section;
...
static int is_ucode(const char *s) {
  if ((s[0] == '<') && (s[1] == 'U') && isxdigit(s[2]) && isxdigit(s[3]) && isxdigit(s[4]) &&
      isxdigit(s[5]) && (s[6] == '>')) {
    return 7;
  } else {
    return 0;
...
#warning check
        ...
        if (find_wi_index_reordered(w->symbol) /* reordered symbol skipped on first pass */
          ...
          /* 							cur_base->name, lli->idx,
           * final_index_val(w->symbol), w->symbol); */
...
/* 				assert(lli->data_type & DT_REORDER); */
        ...
        do {
          ...
          /* 							((section_t *)(lli->data))->name,
           * l2->idx,
           * ((weighted_item_t *)(l2->data))->symbol); */
    ...
    for (s = cl->section_list; s; s = s->next) {
      ...
      do {
        ...
        if (lli->data_type & DT_WEIGHTED) {
          ...
          /* 							cl->name, lli->idx, */
          /* 							final_index_val(((weighted_item_t
           * *)(lli->data))->symbol),
           */
          /* 							((weighted_item_t
           * *)(lli->data))->symbol);
...
#define __LOCALE_DATA_WCctype_II_LEN (tbl->ii_len)
    ...
    fprintf(stderr,
            "%s: %6u invariant  %6u varying  %6u derived  %6u total  %6u max weight  %6u wcs2\n",
            cur_base->name, num_invariant, num_varying, tnumnodes(cur_base->root_derived_wi),
            final_index, max_weight, wcs2index_count);
  }
    ...
    do {
      if (lli->data_type & DT_WEIGHTED) {
        ...
        if (index2weight_len_inc) {
          index2ruleidx_buffer[index2ruleidx_len++] = add_rule((weighted_item_t *)(lli->data));
        }
        /* 				fprintf(stdout, "%11s: w %6d %6d %s\n", */
        /* 						cur_base->name, lli->idx,
         * final_index_val(w->symbol), w->symbol); */
  ...
  if (rli) {
    ...
    base_locale_array[base_locale_len].range_count = ((range_item_t *)(rli->data))->length;
    base_locale_array[base_locale_len].range_base_weight = rli->idx;
    base_locale_array[base_locale_len].range_rule_offset =
        add_range_rule((range_item_t *)(rli->data));
  ...
  if ((strlen(cur_base->name) == 5) && islower(cur_base->name[0]) && islower(cur_base->name[1]) &&
      (cur_base->name[2] == '_') && isupper(cur_base->name[3]) && isupper(cur_base->name[4])) {
    ...
    if ((u16_buf_len > override_len) ||
        !(mm = memmem(override_buffer, override_len * sizeof(override_buffer[0]), u16_buf,
                      u16_buf_len * sizeof(u16_buf[0])))) {
...
LOOP:
    ...
    do {
      if (lli->data_type & DT_WEIGHTED) {
        ...
        if ((n = is_ucode(w->symbol)) != 0) {
          ...
          p = tfind(&x, &cur_base->root_colitem, colitem_cmp);
          if (!p) {
            /* 						fprintf(stderr, "Whoa... processing starters for %s and
             * couldn't find %s\n", */
            /* 								cl->name, w->symbol); */
            continue;
          }
        ...
        if ((tfind(buf, &cur_base->root_starter_char, sym_cmp)) != NULL) {
          /* 					fprintf(stdout, "adding from %s: %s", c->name,
           * w->symbol);
           */
          /* 					if (ci) { */
   ...
   * base_locale_array[base_locale_len].num_starters); */
  ...
  if (u16_buf_len) {
    ...
    if ((u16_buf_len > multistart_len) ||
        !(mm = memmem(multistart_buffer, multistart_len * sizeof(multistart_buffer[0]), u16_buf,
                      u16_buf_len * sizeof(u16_buf[0])))) {
...
static unsigned int add_rule(weighted_item_t *wi) {
  ...
  for (i = 0; i < w->num_weights; i++) {
    ...
    if (*w->colitem[i] == '"') { /* string... */
      ...
      mm = memmem(weightstr_buffer, weightstr_len * sizeof(weightstr_buffer[0]), ws_buf,
                  n * sizeof(ws_buf[0]));
  ...
  memcpy(ruletable_buffer + ruletable_len, rbuf,
         MAX_COLLATION_WEIGHTS * sizeof(ruletable_buffer[0]));
...
static void dump_der_locale(int n) {
  ...
  fprintf(stderr, "Derived Locale: %s (%.12s)", der_locale_array[n].name,
