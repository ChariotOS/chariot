...
#define __LOCALE_DATA_WCctype_TBL_LEN \
  (__LOCALE_DATA_WCctype_II_LEN + __LOCALE_DATA_WCctype_TI_LEN + __LOCALE_DATA_WCctype_UT_LEN)
#define __LOCALE_DATA_WCuplow_TBL_LEN \
  (__LOCALE_DATA_WCuplow_II_LEN + __LOCALE_DATA_WCuplow_TI_LEN + __LOCALE_DATA_WCuplow_UT_LEN)
...
int main(void) {
  ...
  out_u16(lso, __lc_monetary_item_offsets, __lc_monetary_item_offsets_LEN,
  ...
  out_u16(lso, __lc_messages_item_offsets, __lc_messages_item_offsets_LEN,
  ...
  {
    unsigned char co_buf[__LOCALE_DATA_CATEGORIES] = {__lc_ctype_item_offsets_LEN,
...
#ifdef __CTYPE_HAS_8_BIT_LOCALES
  out_uc(lso, (const unsigned char *)__LOCALE_DATA_CODESET_LIST, sizeof(__LOCALE_DATA_CODESET_LIST),
         "codeset_list");
#endif /* __CTYPE_HAS_8_BIT_LOCALES */
