...
extern "C" void __cxa_throw(void* thrown_exception, struct std::type_info * tinfo, void
(*dest)(void*)) { printf("cxa_throw: ex: %p, tinfo: %p, dest: %p", thrown_exception, tinfo, dest);
