...
// If we are told to not define our own unsigned long, then we skip the define.
 ...
 */
extern void *liballoc_alloc(unsigned long);
 ...
 */
extern int liballoc_free(void *, unsigned long);
