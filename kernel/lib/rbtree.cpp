 ...
 */
static inline void __rb_rotate_set_parents(struct rb_node *old, struct rb_node *newnode,
...
void rb_replace_node(struct rb_node *victim, struct rb_node *newnode, struct rb_root *root) {
  ...
  *newnode = *victim;
  ...
  if (victim->rb_left) rb_set_parent(victim->rb_left, newnode);
  if (victim->rb_right) rb_set_parent(victim->rb_right, newnode);
  __rb_change_child(victim, newnode, parent, root);
}

void rb_replace_node_rcu(struct rb_node *victim, struct rb_node *newnode, struct rb_root *root) {
  struct rb_node *parent = rb_parent(victim);
