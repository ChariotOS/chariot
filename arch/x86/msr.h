...
static inline void msr_write(unsigned int msr, unsigned long long data) {
  unsigned int lo = data;
  unsigned int hi = data >> 32;
  asm volatile("wrmsr" : : "c"(msr), "a"(lo), "d"(hi));
}


static inline unsigned long long msr_read(unsigned int msr) {
  unsigned int lo, hi;
