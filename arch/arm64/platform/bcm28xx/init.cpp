...
void rpi_detect(void) {
    ...
    switch ((reg >> 4) & 0xFFF) {
        case 0xB76: bcm28xx_mmio_base = 0x20000000; break;
        case 0xC07: bcm28xx_mmio_base = 0x3F000000; break;
        case 0xD03: bcm28xx_mmio_base = 0x3F000000; break;
        case 0xD08: bcm28xx_mmio_base = 0xFE000000; break;
        default:    bcm28xx_mmio_base = 0x20000000; break;
    }
}
