...
namespace std {
  ...
  _UCXXEXPORT const char* logic_error::what() const _UCXX_USE_NOEXCEPT { return mstring.c_str(); }
  ...
  _UCXXEXPORT const char* runtime_error::what() const _UCXX_USE_NOEXCEPT { return mstring.c_str(); }
