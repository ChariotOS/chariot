...
int sysbind_prctl(int option, unsigned long arg1, unsigned long arg2, unsigned long arg3, unsigned long arg4, unsigned long arg5) {
    return (int)__syscall_eintr(8, (unsigned long long)option, (unsigned long long)arg1, (unsigned long long)arg2, (unsigned long long)arg3, (unsigned long long)arg4, (unsigned long long)arg5);
}

int sysbind_open(const char * path, int flags, int mode) {
    return (int)__syscall_eintr(9, (unsigned long long)path, (unsigned long long)flags, (unsigned long long)mode, 0, 0, 0);
}

int sysbind_close(int fd) {
    return (int)__syscall_eintr(10, (unsigned long long)fd, 0, 0, 0, 0, 0);
}
...
int sysbind_fstat(int fd, struct stat* statbuf) {
    return (int)__syscall_eintr(15, (unsigned long long)fd, (unsigned long long)statbuf, 0, 0, 0, 0);
}

int sysbind_lstat(const char* pathname, struct stat* statbuf) {
    return (int)__syscall_eintr(16, (unsigned long long)pathname, (unsigned long long)statbuf, 0, 0, 0, 0);
}

int sysbind_dup(int fd) {
    return (int)__syscall_eintr(17, (unsigned long long)fd, 0, 0, 0, 0, 0);
}

int sysbind_dup2(int old, int newfd) {
    return (int)__syscall_eintr(18, (unsigned long long)old, (unsigned long long)newfd, 0, 0, 0, 0);
}
...
int sysbind_getcwd(char * dst, int len) {
    return (int)__syscall_eintr(20, (unsigned long long)dst, (unsigned long long)len, 0, 0, 0, 0);
}
...
int sysbind_ioctl(int fd, int cmd, unsigned long value) {
    return (int)__syscall_eintr(23, (unsigned long long)fd, (unsigned long long)cmd, (unsigned long long)value, 0, 0, 0);
}
...
int sysbind_mrename(void * addr, char* name) {
    return (int)__syscall_eintr(33, (unsigned long long)addr, (unsigned long long)name, 0, 0, 0, 0);
}

int sysbind_mgetname(void* addr, char* name, size_t sz) {
    return (int)__syscall_eintr(34, (unsigned long long)addr, (unsigned long long)name, (unsigned long long)sz, 0, 0, 0);
}

int sysbind_mregions(struct mmap_region * regions, int nregions) {
    return (int)__syscall_eintr(35, (unsigned long long)regions, (unsigned long long)nregions, 0, 0, 0, 0);
}

unsigned long sysbind_mshare(int action, void* arg) {
    return (unsigned long)__syscall_eintr(36, (unsigned long long)action, (unsigned long long)arg, 0, 0, 0, 0);
}

int sysbind_dirent(int fd, struct dirent * ent, int offset, int count) {
    return (int)__syscall_eintr(37, (unsigned long long)fd, (unsigned long long)ent, (unsigned long long)offset, (unsigned long long)count, 0, 0);
}

time_t sysbind_localtime(struct tm* tloc) {
    return (time_t)__syscall_eintr(38, (unsigned long long)tloc, 0, 0, 0, 0, 0);
}

size_t sysbind_gettime_microsecond() {
    return (size_t)__syscall_eintr(39, 0, 0, 0, 0, 0, 0);
}

int sysbind_usleep(unsigned long usec) {
    return (int)__syscall_eintr(40, (unsigned long long)usec, 0, 0, 0, 0, 0);
}

int sysbind_socket(int domain, int type, int proto) {
    return (int)__syscall_eintr(41, (unsigned long long)domain, (unsigned long long)type, (unsigned long long)proto, 0, 0, 0);
}

ssize_t sysbind_sendto(int sockfd, const void * buf, size_t len, int flags, const struct sockaddr* addr, size_t addrlen) {
    return (ssize_t)__syscall_eintr(42, (unsigned long long)sockfd, (unsigned long long)buf, (unsigned long long)len, (unsigned long long)flags, (unsigned long long)addr, (unsigned long long)addrlen);
}
...
int sysbind_signal_init(void * sigret) {
    return (int)__syscall_eintr(47, (unsigned long long)sigret, 0, 0, 0, 0, 0);
}

int sysbind_sigaction(int sig, struct sigaction* new_action, struct sigaction* old) {
    return (int)__syscall_eintr(48, (unsigned long long)sig, (unsigned long long)new_action, (unsigned long long)old, 0, 0, 0);
}

int sysbind_sigreturn() {
    return (int)__syscall_eintr(49, 0, 0, 0, 0, 0, 0);
}

int sysbind_sigprocmask(int how, unsigned long set, unsigned long* old_set) {
    return (int)__syscall_eintr(50, (unsigned long long)how, (unsigned long long)set, (unsigned long long)old_set, 0, 0, 0);
}

int sysbind_kill(int pid, int sig) {
    return (int)__syscall_eintr(51, (unsigned long long)pid, (unsigned long long)sig, 0, 0, 0, 0);
}
