...
namespace __cxxabiv1 {
  ...
  struct __class_type_info::__upcast_result {
    ...
    const __class_type_info *base_type;  // where we found the target,
                                         ...
                                         // else NULL
    __upcast_result(int d) : dst_ptr(NULL), part2dst(__unknown), src_details(d), base_type(NULL) {
    }
  };
  ...
  inline __class_type_info::__sub_kind __class_type_info::__find_public_src(
    ...
    if (src2dst >= 0)
      return adjust_pointer<void>(obj_ptr, src2dst) == src_ptr ? __contained_public
                                                               : __not_contained;
