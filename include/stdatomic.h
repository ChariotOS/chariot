...
#define atomic_exchange_explicit(PTR, VAL, MO)                                        \
  __extension__({                                                                     \
    ...
    __atomic_exchange(                                                                \
        __atomic_exchange_ptr, &__atomic_exchange_val, &__atomic_exchange_tmp, (MO)); \
...
#define atomic_compare_exchange_strong_explicit(PTR, VAL, DES, SUC, FAIL)                        \
  __extension__({                                                                                \
    ...
    __atomic_compare_exchange(                                                                   \
        __atomic_compare_exchange_ptr, (VAL), &__atomic_compare_exchange_tmp, 0, (SUC), (FAIL)); \
  })
...
#define atomic_compare_exchange_weak_explicit(PTR, VAL, DES, SUC, FAIL)                          \
  __extension__({                                                                                \
    ...
    __typeof__((void)0, *__atomic_compare_exchange_ptr) __atomic_compare_exchange_tmp = (DES);   \
    __atomic_compare_exchange(                                                                   \
        __atomic_compare_exchange_ptr, (VAL), &__atomic_compare_exchange_tmp, 1, (SUC), (FAIL)); \
  })
