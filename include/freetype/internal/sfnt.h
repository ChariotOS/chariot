 ...
 */
typedef FT_Error (*TT_Init_Face_Func)(FT_Stream stream, TT_Face face, FT_Int face_index,
 ...
 */
typedef FT_Error (*TT_Load_Face_Func)(FT_Stream stream, TT_Face face, FT_Int face_index,
                                      FT_Int num_params, FT_Parameter* params);
 ...
 */
typedef FT_Error (*TT_Load_Any_Func)(TT_Face face, FT_ULong tag, FT_Long offset, FT_Byte* buffer,
                                     FT_ULong* length);
...
typedef FT_Error (*TT_Find_SBit_Image_Func)(TT_Face face, FT_UInt glyph_index,
                                            FT_ULong strike_index, TT_SBit_Range* arange,
                                            TT_SBit_Strike* astrike, FT_ULong* aglyph_offset);
 ...
 *   function exit.
 */
typedef FT_Error (*TT_Load_SBit_Metrics_Func)(FT_Stream stream, TT_SBit_Range range,
 ...
 *   sbit strike exists.
 */
typedef FT_Error (*TT_Load_Strike_Metrics_Func)(TT_Face face, FT_ULong strike_index,
 ...
 */
typedef void (*TT_Get_Metrics_Func)(TT_Face face, FT_Bool vertical, FT_UInt gindex,
 ...
 */
typedef FT_Bool (*TT_Get_Colr_Layer_Func)(TT_Face face, FT_UInt base_glyph, FT_UInt* aglyph_index,
 ...
 */
typedef FT_Error (*TT_Blend_Colr_Func)(TT_Face face, FT_UInt color_index, FT_GlyphSlot base_glyph,
...
#define FT_DEFINE_SFNT_INTERFACE(                                                                  \
    class_, goto_table_, init_face_, load_face_, done_face_, get_interface_, load_any_,            \
    load_head_, load_hhea_, load_cmap_, load_maxp_, load_os2_, load_post_, load_name_, free_name_, \
    load_kern_, load_gasp_, load_pclt_, load_bhed_, load_sbit_image_, get_psname_, free_psnames_,  \
    get_kerning_, load_font_dir_, load_hmtx_, load_eblc_, free_eblc_, set_sbit_strike_,            \
    load_strike_metrics_, load_cpal_, load_colr_, free_cpal_, free_colr_, set_palette_,            \
    get_colr_layer_, colr_blend_, get_metrics_, get_name_, get_name_id_)                           \
  static const SFNT_Interface class_ = {                                                           \
      goto_table_,   init_face_,       load_face_,           done_face_,       get_interface_,     \
      load_any_,     load_head_,       load_hhea_,           load_cmap_,       load_maxp_,         \
      load_os2_,     load_post_,       load_name_,           free_name_,       load_kern_,         \
      load_gasp_,    load_pclt_,       load_bhed_,           load_sbit_image_, get_psname_,        \
      free_psnames_, get_kerning_,     load_font_dir_,       load_hmtx_,       load_eblc_,         \
      free_eblc_,    set_sbit_strike_, load_strike_metrics_, load_cpal_,       load_colr_,         \
      free_cpal_,    free_colr_,       set_palette_,         get_colr_layer_,  colr_blend_,        \
      get_metrics_,  get_name_,        get_name_id_};
