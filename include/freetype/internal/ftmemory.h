...
FT_BASE(FT_Pointer)
ft_mem_realloc(FT_Memory memory, FT_Long item_size, FT_Long cur_count, FT_Long new_count,
               void* block, FT_Error* p_error);

FT_BASE(FT_Pointer)
ft_mem_qrealloc(FT_Memory memory, FT_Long item_size, FT_Long cur_count, FT_Long new_count,
                void* block, FT_Error* p_error);
...
#define FT_MEM_REALLOC(ptr, cursz, newsz) \
  FT_ASSIGNP_INNER(ptr,                   \
                   ft_mem_realloc(memory, 1, (FT_Long)(cursz), (FT_Long)(newsz), (ptr), &error))
...
#define FT_MEM_QREALLOC(ptr, cursz, newsz) \
  FT_ASSIGNP_INNER(ptr,                    \
                   ft_mem_qrealloc(memory, 1, (FT_Long)(cursz), (FT_Long)(newsz), (ptr), &error))

#define FT_MEM_ALLOC_MULT(ptr, count, item_size) \
  FT_ASSIGNP_INNER(                              \
      ptr, ft_mem_realloc(memory, (FT_Long)(item_size), 0, (FT_Long)(count), NULL, &error))

#define FT_MEM_REALLOC_MULT(ptr, oldcnt, newcnt, itmsz)                             \
  FT_ASSIGNP_INNER(ptr, ft_mem_realloc(memory, (FT_Long)(itmsz), (FT_Long)(oldcnt), \
                                       (FT_Long)(newcnt), (ptr), &error))

#define FT_MEM_QALLOC_MULT(ptr, count, item_size) \
  FT_ASSIGNP_INNER(                               \
      ptr, ft_mem_qrealloc(memory, (FT_Long)(item_size), 0, (FT_Long)(count), NULL, &error))

#define FT_MEM_QREALLOC_MULT(ptr, oldcnt, newcnt, itmsz)                             \
  FT_ASSIGNP_INNER(ptr, ft_mem_qrealloc(memory, (FT_Long)(itmsz), (FT_Long)(oldcnt), \
                                        (FT_Long)(newcnt), (ptr), &error))
...
#define FT_MEM_RENEW_ARRAY(ptr, cursz, newsz)                                                      \
  FT_ASSIGNP_INNER(ptr, ft_mem_realloc(memory, sizeof(*(ptr)), (FT_Long)(cursz), (FT_Long)(newsz), \
                                       (ptr), &error))
...
#define FT_MEM_QRENEW_ARRAY(ptr, cursz, newsz)                                    \
  FT_ASSIGNP_INNER(ptr, ft_mem_qrealloc(memory, sizeof(*(ptr)), (FT_Long)(cursz), \
