...
typedef FT_Long (*PS_GetFontValueFunc)(FT_Face face, PS_Dict_Keys key, FT_UInt idx, void* value,
                                       FT_Long value_len);
...
#define FT_DEFINE_SERVICE_PSINFOREC(class_, get_font_info_, ps_get_font_extra_, has_glyph_names_, \
                                    get_font_private_, get_font_value_)                           \
  static const FT_Service_PsInfoRec class_ = {                                                    \
      get_font_info_, ps_get_font_extra_, has_glyph_names_, get_font_private_, get_font_value_};
