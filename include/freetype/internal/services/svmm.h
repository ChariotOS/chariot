...
typedef FT_Error (*FT_Get_Var_Blend_Func)(FT_Face face, FT_UInt* num_coords, FT_Fixed** coords,
...
#define FT_DEFINE_SERVICE_MULTIMASTERSREC(class_, get_mm_, set_mm_design_, set_mm_blend_,    \
                                          get_mm_blend_, get_mm_var_, set_var_design_,       \
                                          get_var_design_, set_instance_, set_weightvector_, \
