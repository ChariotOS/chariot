...
#define FT_PEEK_LONG(p)                                                           \
  FT_INT32(FT_BYTE_U32(p, 0, 24) | FT_BYTE_U32(p, 1, 16) | FT_BYTE_U32(p, 2, 8) | \
           FT_BYTE_U32(p, 3, 0))
...
#define FT_PEEK_OFF3(p) \
  FT_INT32(FT_BYTE_U32(p, 0, 16) | FT_BYTE_U32(p, 1, 8) | FT_BYTE_U32(p, 2, 0))
...
#define FT_PEEK_LONG_LE(p)                                                        \
  FT_INT32(FT_BYTE_U32(p, 3, 24) | FT_BYTE_U32(p, 2, 16) | FT_BYTE_U32(p, 1, 8) | \
           FT_BYTE_U32(p, 0, 0))
...
#define FT_PEEK_OFF3_LE(p) \
  FT_INT32(FT_BYTE_U32(p, 2, 16) | FT_BYTE_U32(p, 1, 8) | FT_BYTE_U32(p, 0, 0))
...
#define FT_STREAM_READ_AT(position, buffer, count) \
  FT_SET_ERROR(                                    \
      FT_Stream_ReadAt(stream, (FT_ULong)(position), (FT_Byte*)(buffer), (FT_ULong)(count)))
...
#define FT_FRAME_EXTRACT(size, bytes) \
  FT_SET_ERROR(                       \
      FT_DEBUG_INNER(FT_Stream_ExtractFrame(stream, (FT_ULong)(size), (FT_Byte**)&(bytes))))
