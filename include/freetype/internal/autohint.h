 ...
 */
typedef void (*FT_AutoHinter_GlobalGetFunc)(FT_AutoHinter hinter, FT_Face face, void** global_hints,
                                            long* global_len);
 ...
 */
typedef FT_Error (*FT_AutoHinter_GlyphLoadFunc)(FT_AutoHinter hinter, FT_GlyphSlot slot,
                                                FT_Size size, FT_UInt glyph_index,
                                                FT_Int32 load_flags);
...
#define FT_DEFINE_AUTOHINTER_INTERFACE(class_, reset_face_, get_global_hints_, done_global_hints_, \
                                       load_glyph_)                                                \
  FT_CALLBACK_TABLE_DEF                                                                            \
  const FT_AutoHinter_InterfaceRec class_ = {reset_face_, get_global_hints_, done_global_hints_,   \
                                             load_glyph_};
